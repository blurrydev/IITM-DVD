...
\texttt{report/DVD\_Team\_001\_Technical\_Report} on the GitHub repository above \\[4pt]
Kaggle notebooks (interactive EDA) &
\textit{[Link to be added --- public Kaggle notebook link pending]} \\[4pt]
Final presentation &
\textit{[Link to be added --- public presentation link pending]} \\
\bottomrule
\end{tabularx}
\end{table}
